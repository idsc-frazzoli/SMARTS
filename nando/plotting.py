...
#%% 15.03.2022: merge110_lanes2 decentralized for 5 hours 
# rudolf with num_workers = 19

scenario = 'merge110_lanes2-4'
# centralized
name_0 = 'PPO_FrameStack_f8f98_00000_0_2022-03-17_11-39-58'
# all decentralized
name_1 = 'PPO_FrameStack_4f155_00000_0_2022-03-16_08-44-36'
name_2 = 'PPO_FrameStack_67136_00000_0_2022-03-15_10-33-50'
name_3 = 'PPO_FrameStack_84551_00000_0_2022-03-15_17-08-21'

title = 'Decentralized Tests for merge110_lanes2'



progress_path_0 = os.path.join('../baselines', 'marl_benchmark', 'log', 'results', 'run',
                                scenario,
                                name_0,
                                'progress.csv')
...
df_progress_0 = pd.read_csv(progress_path_0)
df_progress_1 = pd.read_csv(progress_path_1)
df_progress_2 = pd.read_csv(progress_path_2)
df_progress_3 = pd.read_csv(progress_path_3)

df_ep_rew_0 = df_progress_0['hist_stats/episode_reward']
df_ep_rew_1 = df_progress_1['hist_stats/episode_reward']
df_ep_rew_2 = df_progress_2['hist_stats/episode_reward']
df_ep_rew_3 = df_progress_3['hist_stats/episode_reward']

rewards_0 = df_progress_0[['episode_reward_mean','episode_reward_max','episode_reward_min']]
rewards_1 = df_progress_1[['episode_reward_mean','episode_reward_max','episode_reward_min']]
rewards_2 = df_progress_2[['episode_reward_mean','episode_reward_max','episode_reward_min']]
rewards_3 = df_progress_3[['episode_reward_mean','episode_reward_max','episode_reward_min']]

rew_std_up_0 = [np.percentile(str2list(x),84) for x in df_ep_rew_0]
rew_std_lo_0 = [np.percentile(str2list(x),16) for x in df_ep_rew_0]
rew_std_up_1 = [np.percentile(str2list(x),84) for x in df_ep_rew_1]
rew_std_lo_1 = [np.percentile(str2list(x),16) for x in df_ep_rew_1]
rew_std_up_2 = [np.percentile(str2list(x),84) for x in df_ep_rew_2]
rew_std_lo_2 = [np.percentile(str2list(x),16) for x in df_ep_rew_2]
...
rew_2std_up_0 = [np.percentile(str2list(x),97.5) for x in df_ep_rew_0]
rew_2std_lo_0 = [np.percentile(str2list(x),2.5) for x in df_ep_rew_0]
rew_2std_up_1 = [np.percentile(str2list(x),97.5) for x in df_ep_rew_1]
rew_2std_lo_1 = [np.percentile(str2list(x),2.5) for x in df_ep_rew_1]
rew_2std_up_2 = [np.percentile(str2list(x),97.5) for x in df_ep_rew_2]
rew_2std_lo_2 = [np.percentile(str2list(x),2.5) for x in df_ep_rew_2]
...
rew_median_0 = [np.median(str2list(x)) for x in df_ep_rew_0]
rew_median_1 = [np.median(str2list(x)) for x in df_ep_rew_1]
rew_median_2 = [np.median(str2list(x)) for x in df_ep_rew_2]
...
ax.fill_between(np.arange(1,len(rew_std_up_0)+1), rew_std_up_0, rew_std_lo_0, color=[0,0,0,0.2])
# ax.fill_between(np.arange(1,len(rew_std_up_1)+1), rew_std_up_1, rew_std_lo_1, color=[0,0.3,1,0.2])
# ax.fill_between(np.arange(1,len(rew_std_up_2)+1), rew_std_up_2, rew_std_lo_2, color=[1,0.3,0,0.2])
# ax.fill_between(np.arange(1,len(rew_std_up_3)+1), rew_std_up_3, rew_std_lo_3, color=[0,1,0.3,0.2])


ax.plot(rew_median_0, color=[0,0,0,0.2], label='centralized')
# ax.plot(rew_median_1, color=[0,0.3,1,1], label='decentralized 1')
# ax.plot(rew_median_2, color=[1,0.3,0,1], label='decentralized 2')
# ax.plot(rew_median_3, color=[0,1,0.3,1], label='decentralized 3')
...
# plt.savefig("plots/{}_decen.pdf".format(scenario))
plt.show()
