...
class StraightLane:
    ...
    def plot(self, ax):
        ...
        for center_line in self.center_lines:
            ax.plot(center_line[0], center_line[1], color='white', linewidth=5, linestyle='--')
...
class Map:
    def __init__(self, lanes: Union[List[StraightLane], Any],
                 ...
                 empty: bool = False,
                 polygons_x=None, polygons_y=None):
        self.lanes = lanes
        self.x_lim = x_lim
        self.y_lim = y_lim
        self.aspect_ratio = aspect_ratio
        self.empty = empty
        self.polygons_x = polygons_x
        self.polygons_y = polygons_y
    ...
    def plot(self, ax):
        ...
        if self.polygons_x:
            for i in range(len(self.polygons_x)):
                ax.fill(self.polygons_x[i], self.polygons_y[i], color="#CDCDCD")
